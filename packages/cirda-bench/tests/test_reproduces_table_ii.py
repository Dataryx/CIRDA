...
# Regenerated against compare_table_ii.py after all-or-nothing direct loss +
# multi-channel union recovery. CIRDA false_safe@30/45/60 is asserted exact 0
# outside this set.
